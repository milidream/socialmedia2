...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Permission::create(['name' => 'update all posts']);
        ...
        $user->givePermissionTo('update own posts');
        $user->givePermissionTo('delete own posts');

        $user->givePermissionTo('update own comments');
        $user->givePermissionTo('delete own comments');
        ...
        $admin->givePermissionTo('update all posts');
        $admin->givePermissionTo('delete all posts');

        $admin->givePermissionTo('update all comments');
        $admin->givePermissionTo('delete all comments');
